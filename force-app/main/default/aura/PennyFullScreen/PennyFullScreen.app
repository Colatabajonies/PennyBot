<aura:application implements="force:appHostable,lightning:isUrlAddressable" extends="force:slds">
    ...
    <c:PennyMainDisplay refId="{!v.engagementId}" displayALL="{!v.displayALL}" chatZoom="{!v.chatZoom}" vfURL="https://gilmorelabsp19.my.salesforce.com/apex/PennyWordCloudVF" autoScroll="true" />
</aura:application>